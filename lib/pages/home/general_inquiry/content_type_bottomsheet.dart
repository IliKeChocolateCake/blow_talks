...
import 'package:blow_talks/pages/home/general_inquiry/classroom/classroom.dart';
...
import 'package:blow_talks/pages/home/general_inquiry/events/events.dart';
...
class ContentTypeBottomsheet extends StatefulWidget{

  const ContentTypeBottomsheet ({super.key});


  @override
  State<ContentTypeBottomsheet> createState() => ContentTypeBottomsheetPage();

}

class ContentTypeBottomsheetPage extends State<ContentTypeBottomsheet>{
  @override
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _titleLog('Classroom', 'asset/classroom.png', AppOthers.lightOrangeMain, onTap: (){
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => const Classroom()),
                        );
                      } ),
