...
class CourseDetailsSelectedMember extends StatefulWidget {
  const CourseDetailsSelectedMember({super.key});

  @override
  State<CourseDetailsSelectedMember> createState() => CourseDetailsSelectedMemberPage();
}

class CourseDetailsSelectedMemberPage extends State<CourseDetailsSelectedMember> {
