...
class CourseDetailsFree extends StatefulWidget {
  const CourseDetailsFree({super.key});

  @override
  State<CourseDetailsFree> createState() => CourseDetailsFreePage();
}

class CourseDetailsFreePage extends State<CourseDetailsFree> {
