...
import 'package:blow_talks/pages/home/general_inquiry/events/event_type/one_off.dart';
...
class EventsList extends StatefulWidget{
  ...
  @override
  State<EventsList> createState() => EventsListPage();
}


class EventsListPage extends State<EventsList>{
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Events('asset/events/dance.png', 'Dance the Night Away Party', false, '08:00 PM', '3966 Watson Street, New Jersey',false, onTap: (){
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const OneOff()),
              );
            }),
