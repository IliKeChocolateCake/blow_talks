...
class CreatorDiscussion extends StatefulWidget{

  const CreatorDiscussion  ({super.key});


  @override
  State<CreatorDiscussion > createState() => DiscussionPage();

}


class DiscussionPage extends State<CreatorDiscussion > {
  @override
