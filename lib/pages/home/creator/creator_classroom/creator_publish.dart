...
class CreatorPublish extends StatefulWidget {
  const CreatorPublish({super.key});

  @override
  State<CreatorPublish> createState() => CourseDetailsPaidPage();
}

class CourseDetailsPaidPage extends State<CreatorPublish> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 8,),
                        Text('This course is now on draft mode',style: text14Regular.copyWith(color: AppGrey.light200),),
                      ],
