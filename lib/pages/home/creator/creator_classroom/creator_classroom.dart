...
import 'package:blow_talks/pages/home/creator/creator_classroom/creator_course_list.dart';
...
class CreatorClassroom extends StatefulWidget{

  const CreatorClassroom ({super.key});

  @override
  State<CreatorClassroom> createState() => CreatorClassroomPage();


}


class CreatorClassroomPage extends State<CreatorClassroom>{
  @override
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: TabBarView(
                  children: [
                    Center(child: CreatorCourseList()),
