...
class CreatorArchive extends StatefulWidget {
  const CreatorArchive ({super.key});

  @override
  State<CreatorArchive > createState() => CourseDetailsSelectedMemberPage();
}

class CourseDetailsSelectedMemberPage extends State<CreatorArchive > {
  ...
  Future<void> _generatePalette() async {
    final paletteGenerator = await PaletteGeneratorMaster.fromImageProvider(
      AssetImage('asset/classroom/machine_learning.png'),
    );
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Icon(Icons.info_outline, color: AppGrey.light50, size: 14,),
                        SizedBox(width: 8,),
                        ...
                        Expanded(
                          ...
                          child:RichText(
                          text: TextSpan(
                            style: text14Regular.copyWith(color: AppGrey.light200),
                            children: [
                              TextSpan(text: 'This course was archived on '),
                              TextSpan(text: 'June 19, 2025', style: text14Bold.copyWith(color: AppGrey.light200)),
                              TextSpan(text: ', but remains accessible to enrolled members.'),
                            ],
                          ),
                        ),),
                    ...
                    SizedBox(height: 20),
                    Image.asset('asset/classroom/machine_learning.png'),
                    SizedBox(height: 20),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Machine Learning 101', style: text24Bold.copyWith(color: Colors.white)),
                        Spacer(),
                        Container(
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 8,),
                        Text('Selected Member Only', style: text14Medium.copyWith(color: Colors.white.withValues(alpha: 0.7)),)
                    ...
                    Text('Embark on your Machine Learning journey with \'ML 101\'. This course simplifies complex concepts, offering a clear path from foundational knowledge to practical application in the realm of artificial intelligence. ',style: text14Regular.copyWith(color: Colors.white),),
                    Text('\nDive into algorithms, data analysis techniques, and model building strategies. Perfect for beginners and seasoned professionals eager to expand their knowledge in the world of AI and machine learning.',style: text14Regular.copyWith(color: Colors.white),),
                    SizedBox(height: 32,),
                    ...
                    InkWell(
                      ...
                      child:  Row(
                        ...
                        children: [
                          ...
                          Text('Data Preprocessing: Preparing Your Dataset', style: text14Medium.copyWith(color: Colors.white),),
                    ...
                    InkWell(
                      ...
                      child:  Row(
                        ...
                        children: [
                          ...
                          Text('Model Training: Building Your First Model', style: text14Medium.copyWith(color: Colors.white),),
                    ...
                    InkWell(
                      ...
                      child:  Row(
                        ...
                        children: [
                          ...
                          Text('Evaluation Metrics: Measuring Model Performance', style: text14Medium.copyWith(color: Colors.white),),
                    ...
                    review(
                      ...
                      starCount: 4,
                      timeAgo: '15d ago',
                      description: 'Very helpful for beginners.',
                    ),
