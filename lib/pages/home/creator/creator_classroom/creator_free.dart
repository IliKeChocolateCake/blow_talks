...
class CreatorCourseDetailsFree extends StatefulWidget {
  const CreatorCourseDetailsFree({super.key});

  @override
  State<CreatorCourseDetailsFree> createState() => CourseDetailsFreePage();
}

class CourseDetailsFreePage extends State<CreatorCourseDetailsFree> {
  ...
  Future<void> _generatePalette() async {
    final paletteGenerator = await PaletteGeneratorMaster.fromImageProvider(
      AssetImage('asset/classroom/free.png'),
    );
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    Image.asset('asset/classroom/free.png'),
                    SizedBox(height: 20),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Introduction to Artificial \nIntelligence', style: text24Bold.copyWith(color: Colors.white)),
                        Spacer(),
                        Container(
                          ...
                          child: Wrap(
                            ...
                            children: [
                              ...
                              Text('4.9', style: text10Medium.copyWith(color: AppOthers.lightYellowMain)),
                            ],
                          ),
                        ),
                    ...
                    Row(
                      children: [
                        ...
                        Icon(Icons.monetization_on, size: 16, color: Colors.white.withValues(alpha: 0.7)),
                        SizedBox(width: 8,),
                        Text('Free', style: text14Medium.copyWith(color: Colors.white.withValues(alpha: 0.7)),)
                    ...
                    Text('Embark on a transformative journey into the world of \'Introduction to Artificial Intelligence\'. Explore machine learning, neural networks, and robotics. Through hands-on projects, grasp AI\'s potential to revolutionise industries and solve complex problems. Delve into real-world case studies, and discover how AI is shaping our future. Join our vibrant community of learners to unlock the future and harness the power of intelligent machines.',style: text14Regular.copyWith(color: Colors.white),),
                    Text('\nWhether you\'re a beginner or an expert, this course offers invaluable insights and practical skills to thrive in the age of AI. Master algorithms, explore data science, and create intelligent solutions. Connect with industry experts, build a portfolio, and gain a competitive edge in the rapidly evolving field of artificial intelligence. Start your AI adventure today!',style: text14Regular.copyWith(color: Colors.white),),
                    ...
                    InkWell(
                      ...
                      child:  Row(
                        ...
                        children: [
                          ...
                          Text('AI Fundamentals: An Overview', style: text14Medium.copyWith(color: Colors.white),),
                    ...
                    Padding(padding: EdgeInsets.all(16),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('1 Introduction to Neural Networks', style: text14Medium.copyWith(color: Colors.white),),

                          SizedBox(height: 12,),

                          Text('2 Deep Learning Architecture', style: text14Medium.copyWith(color: Colors.white),),

                          SizedBox(height: 12,),

                          Text('3 Natural Language Processing Basics', style: text14Medium.copyWith(color: Colors.white),),

                          SizedBox(height: 12,),

                          Text('4 Computer Vision Techniques', style: text14Medium.copyWith(color: Colors.white),),

                          SizedBox(height: 12,),

                          Text('5 AI Ethics and Societal Impacts', style: text14Medium.copyWith(color: Colors.white),),
                    ...
                    review(
                      userName: 'Evelyne Hayes',
                      starCount: 5,
                      timeAgo: '1d ago',
                      description: 'A fantastic intro to AI! Highly recommend for beginners.',
                    ),
                    ...
                    review(
                      ...
                      starCount: 4,
                      timeAgo: '4d ago',
                      description: 'The course content is well-structured and easy to follow.',
                    ),
                    ...
                    review(
                      ...
                      starCount: 4,
                      timeAgo: '1w ago',
                      description: 'I gained practical skills in AI that I can apply to my projects.',
                    ),
