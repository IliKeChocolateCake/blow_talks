...
class EditEvents extends StatefulWidget {
  ...
  @override
  State<EditEvents> createState() => CreateEventPage();
}

class CreateEventPage extends State<EditEvents> {
  final TextEditingController _nameController = TextEditingController(text: 'Annual Meet-up');
  final TextEditingController _linkController = TextEditingController(text: 'https://zoom.us/j/1234567890');
  final TextEditingController _descController = TextEditingController(text: 'Join us for our Annual Meetup, a fantastic opportunity to connect with fellow enthusiasts, share ideas, and celebrate our community\'s achievements. Enjoy engaging discussions, fun activities, and networking opportunities. Don\'t miss out on this chance to be part of something special!');
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Center(
                      child: Text('Edit Event', style: text16Bold.copyWith(color: AppGrey.lightMain)),
                    ),
                  ),
                  InkWell(
                    onTap: () {},
