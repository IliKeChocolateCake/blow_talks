...
import 'package:blow_talks/pages/profile/profile_setting/account/change_email_three.dart';
import 'package:flutter/material.dart';
import 'package:pin_code_fields/pin_code_fields.dart';



class ChangeEmailTwo extends StatefulWidget{

  const ChangeEmailTwo ({super.key});

  @override
  State<ChangeEmailTwo> createState() => ChangeEmailTwoPage();

}

class ChangeEmailTwoPage extends State<ChangeEmailTwo>{
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Step 2 of 4', style: text14Regular.copyWith(color: AppGrey.light500),),
                        ],
                      ),
                    ),
              ...
              PinInput(
                ...
                onCompleted: (value) {
                  if (int.parse(value) == pinCode) {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const ChangeEmailThree()),
                    );
                  } else {
                    // wrong PIN
